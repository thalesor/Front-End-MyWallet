...
const Entrada = () =>
{
    ...
    async function onSaveRegistry(e)
    {
        ...
        if(validation.hasErrors === false)
        {
            try
            {
                await insertRegistry({...formData, userId : userData.userId, create_date: Date.now(), type:'income'}, userData.token);
                message(`Sua entrada foi registrada 🤑`, 'success', 'Tudo certo!', hideMessage());
                navigate('/home');
            }
            catch(err)
